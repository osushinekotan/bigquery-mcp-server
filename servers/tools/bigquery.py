...
from servers.schemas.bigquery import ColumnDetails, Dataset, QueryRequest, QueryResult, Table, TableDetails, TableSchema
...
@mcp.resource(uri="bigquery://dataset_list", tags=["bigquery"])
...
@mcp.resource(uri="bigquery://allowed_datasets", tags=["bigquery"])
...
@mcp.resource(uri="bigquery://{dataset_id}/table_list", tags=["bigquery"])
async def list_tables(dataset_id: str | None) -> list[Table]:
    """
...
@mcp.resource(uri="bigquery://{dataset_id}/{table_id}/details", tags=["bigquery"])
async def describe_table(dataset_id: str, table_id: str) -> TableDetails:
    """
...
@mcp.tool(name="execute_query", tags=["bigquery"])
async def execute_query(query_request: QueryRequest) -> QueryResult:
    """
